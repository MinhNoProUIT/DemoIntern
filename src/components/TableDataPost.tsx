            ...
            <TableRow key={index} sx={{ height: `${rowHeight}px` }}>
              ...
              <TableCell padding="normal">
                <Box display="flex" alignItems="center" gap={2}>
                  <Avatar src={row.createdByAvatar ?? ""} />
                  <Box>
                    <Typography
                      variant="body1"
              ...
              >
                <Typography variant="body1">{row.totalPosts}</Typography>
              </TableCell>
              {/* Likes */}
              <TableCell
                align="center"
                sx={{ paddingRight: 5, color: "var(--text-color)" }}
              >
                <Typography variant="body1">{row.likesCount}</Typography>
              </TableCell>
              {/* Shares */}
              <TableCell
                align="center"
                sx={{ paddingRight: 5, color: "var(--text-color)" }}
              >
                <Typography variant="body1">{row.sharesCount}</Typography>
              </TableCell>
